...
<form method="post">
            ...
            <div class="text">
                <p class="top">FORGOT PASSWORD?</p>
                <p>Please enter your Email associated <br/> with your account</p>
            </div>
            <div class="form">
...
// Retrieve value from HTML textbox
$username = $_POST['username'];

// SQL query to check if username exists in table
$sql = "SELECT * FROM clients WHERE email = '$username'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    // echo"<a href=reset_password.php?username=$username">"";
     exit();
